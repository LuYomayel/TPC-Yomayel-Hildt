...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Ventas</h1>
    <asp:GridView ID="gvVentas" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" OnRowCommand="gvVentas_RowCommand" OnRowDeleting="gvVentas_RowDeleting">
        <Columns>
